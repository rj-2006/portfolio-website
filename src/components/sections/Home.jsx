    ...
    <RevealOnScroll>
        <div classname="text-center z-10 px-4">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                I'm a Full-Stack Developer who likes to create cool stuff.
            </p>
            ...
            <div className="flex justify-center space-x-4">
                ...
                font-medium transition:all duration:200 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59,130,246,0.2)

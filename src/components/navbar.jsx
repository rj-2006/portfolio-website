...
export const Navbar = ({menuOpen,setMenuOpen}) =>{
    ...
    return (
        <nav className="fixed top-0 w-full z-40 bg-[rgba(10,10,10,0.8] backdrop-blur-lg border-bottom-white/10 shaow-lg">
            <div className="max-w-5xl  mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    <a href="#home" className="font-mono text-xl font-bold text-white">
                        ketu<span className="text-blue-500">.verse</span>
                    </a>
                    ...
                    <div className="hidden md:flex itemms-center space-x-8">
